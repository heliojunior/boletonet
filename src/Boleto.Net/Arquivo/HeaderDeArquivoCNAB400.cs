...
namespace BoletoNet
{
    public class HeaderDeArquivoCNAB400
    {
        #region Variáveis
        ...
        public void LerHeaderDeArquivoCNAB400(string Registro)
        {
            try
            {
                if ((Registro.Substring(3, 7)).ToUpper() != "RETORNO")
