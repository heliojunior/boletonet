    ...
    internal class Banco_Itau : AbstractBanco, IBanco
    {
        ...
        private string GerarHeaderLoteRemessaCNAB240(Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                ...
                header += Utils.FormatCode(cedente.Endereco.Logradouro, " ", 30); // rua
                header += Utils.FormatCode(cedente.Endereco.Numero, "0", 5, true);
                header += Utils.FormatCode(cedente.Endereco.Complemento, " ", 15);
                header += Utils.FormatCode(cedente.Endereco.Cidade, " ", 20);
                header += Utils.FormatCode(cedente.Endereco.CEP,"0", 8, true);
                header += cedente.Endereco.UF;
        ...
        public string GerarDetalheRemessaCNAB240(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                detalhe += Utils.FormatCode("", "0", 5, true); // numero da conta debitada
